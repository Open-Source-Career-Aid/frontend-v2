        ...
        { !showscore ?
            ...
            <div className="flex flex-row w-full h-[40px] shadow-md bg-white rounded-md m-auto">
              <div className="flex w-full justify-between">
                  <h5 className="small-heading-h5 text-text-primary m-auto">Topic: <a href={url} className="cursor-pointer" target="_blank" rel="noreferrer" > <span className="text-orange-strong">{topic}</span> </a></h5>
